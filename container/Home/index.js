...
export default function HomePage() {
    return (
        <div className="relative h-full bg-blackGray20">
            <Container>
                <div className="flex lg:flex-row text-white sm:min-h-screen flex-col lg:border-b-4 border-greenLantern">
                ...
                <section id="projects" className="top-44" />
                <div className="text-white h-jumbotron bg-red">
                    ...
                    <div className="max-w-sm min-w-[340px] min-h-screen bg-white shadow-md rounded-3xl p-2 mx-1 my-3 cursor-pointer">
